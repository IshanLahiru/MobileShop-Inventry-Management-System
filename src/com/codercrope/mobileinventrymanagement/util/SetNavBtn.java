...
public class SetNavBtn {
    ...
    public static void setBtn(GridPane pane, String event, NavBtn type) {
        ...
        switch (type) {
            ...
            case BILLING:
                try {
                    ButtonBillingSideVBController controller = (ButtonBillingSideVBController) initBtn(event, pane).getController();
                    navIcoController.put("billing", controller);
                    controller.getPane(grid);
                    ImageView img = controller.getImage();
                    navIco.put("billing", img);
                } catch (Exception e) {
                    e.printStackTrace();
                }
                break;
